...
<html>
  	...
  	<body>
		<div class="container">
            <div class="form">
                <form id="form_login" method="POST" action="student_controller.php?action=login&language=<?=$language?>" onSubmit="handleSubmitForm(event)">
                    ...
                    <h4>
                        <?php echo $link_h4[$language]['1']?><a style="color:#8cc63f; padding-left:10px" href="student_registration.php?language=<?=$language?>"><?php echo $link_h4[$language]['2']?></a>
                    </h4>
                </form>
            </div>
