...
--
-- Table structure for table `tb_my_courses`
--

DROP TABLE IF EXISTS `tb_my_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tb_my_courses` (
  ...
  CONSTRAINT `tb_my_courses_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `tb_user_student` (`student_id`),
  CONSTRAINT `tb_my_courses_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `tb_user_teacher` (`teacher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_my_courses`
--

LOCK TABLES `tb_my_courses` WRITE;
/*!40000 ALTER TABLE `tb_my_courses` DISABLE KEYS */;
INSERT INTO `tb_my_courses` VALUES (1,20,9),(2,20,11),(3,20,11),(4,21,11),(5,20,9);
/*!40000 ALTER TABLE `tb_my_courses` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_user_teacher` VALUES (7,'Jorge','Silva','Culinária','Porto','12345','../../public/img/profile_photos/63a9b0f76925e.jpg','2022-12-26 11:34:31','jorge.silva@gmail.com'),(8,'André','Piacquadio','Física','Porto','654321','../../public/img/profile_photos/63a9b1a6c929b.jpg','2022-12-26 11:37:26','andre.piac@hotmail.com'),(9,'Bruno','Salvador','Fotografia','Porto','987654','../../public/img/profile_photos/63a9b20bb2162.jpg','2022-12-26 11:39:07','bruno.salvador@gmail.com'),(10,'Yang','Shein','Mandarin','Lisboa','456789','../../public/img/profile_photos/63a9b24baa488.jpg','2022-12-26 11:40:11','yang.shein@gmail.com'),(11,'Nathan','Cowley','Montanhismo','Lisboa','987654','../../public/img/profile_photos/63a9b2bf33a17.jpg','2022-12-26 11:42:07','nathan.cowley@gmail.com'),(12,'Margarida','Piacquadio','Fotografia','Coimbra','987654','../../public/img/profile_photos/63a9f510a6090.jpg','2022-12-26 16:25:04','margarida.piac@gmail.com'),(13,'Luiza','Dolgikh','Fotografia','Braga','321654','../../public/img/profile_photos/63a9f5504bc94.jpg','2022-12-26 16:26:08','luiza.dolgikh@gmail.com'),(14,'Maria','João','Mandarin','Coimbra','465132','../../public/img/profile_photos/63a9f610be567.jpg','2022-12-26 16:29:20','maria.joao@gmail.com');
...
-- Dump completed on 2023-01-18 23:27:02
